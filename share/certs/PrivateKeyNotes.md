...
unlocked to sign the Carpediemcoin-Qt.app bundle.
...
allowing somebody to distribute a Carpediemcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the carpediemcoin-qt.exe file inside the installer had not been tampered with.
