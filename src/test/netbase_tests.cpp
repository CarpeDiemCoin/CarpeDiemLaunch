...
{
    BOOST_CHECK(TestSplitHost("www.carpediem.com", "www.carpediem.com", -1));
    BOOST_CHECK(TestSplitHost("[www.carpediem.com]", "www.carpediem.com", -1));
    BOOST_CHECK(TestSplitHost("www.carpediem.com:80", "www.carpediem.com", 80));
    BOOST_CHECK(TestSplitHost("[www.carpediem.com]:80", "www.carpediem.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:6480", "127.0.0.1", 6480));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6480", "127.0.0.1", 6480));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6480", "::ffff:127.0.0.1", 6480));
    BOOST_CHECK(TestSplitHost("[::]:6480", "::", 6480));
    BOOST_CHECK(TestSplitHost("::6480", "::6480", -1));
    BOOST_CHECK(TestSplitHost(":6480", "", 6480));
    BOOST_CHECK(TestSplitHost("[]:6480", "", 6480));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6480", "127.0.0.1:6480"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6480", "[::]:6480"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
